...
const { createSnookerGame, updateSnookerGame, setWinner, getAllSnookerGames, getSnookerGameById, deleteSnookerGame } = require('../../../../controllers/games/teamGames/snooker/snooker');
...
router.delete('/delete/:eventId', verifyOrganizersToken, deleteSnookerGame);
