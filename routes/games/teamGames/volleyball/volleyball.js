...
const { createVolleyballGame, updateVolleyvallGame, getAllVolleyballGames, setWinner, getVolleyballGameById, deleteVolleyballGame } = require('../../../../controllers/games/teamGames/volleyball/volleyball');
...
router.delete('/delete/:eventId', verifyOrganizersToken, deleteVolleyballGame);
