...
const { addPoint, removePoint, getPoint, getAllPointsOfSet, allPointsByTeamInSet, allPointsByTeam, allPointsByPlayer, allPointsByPlayerInSet } = require('../../../../controllers/games/teamGames/badminton/point');
